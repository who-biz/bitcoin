...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-nSPV", strprintf("Komodo flag for discerning nspv_fullnode/nspv_superlite", DEFAULT_NSPV_PROCESSING), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
