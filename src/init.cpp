...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-pubkey=<pubkey>", "Add a pubkey for notarizations, used only by notary nodes", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    ...
    argsman.AddArg("-nspv_msg", strprintf("Enable NSPV messages processing (default: %u)", DEFAULT_NSPV_PROCESSING), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
    argsman.AddArg("-nSPV", strprintf("Komodo flag for discerning between nspv_fullnode/nspv_superlite (default: %u)", DEFAULT_NSPV_PROCESSING), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
