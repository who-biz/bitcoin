...
UniValue netpeercount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            "net_peerCount\n"
    ...
    peer_stream << "0x" << std::hex << (int)vNodes.size();
    valReply.setStr(peer_stream.str());
    return valReply;
}
...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:41888\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:41888\", \"onetry\"")
        );
...
UniValue disconnectnode(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "1. \"node\"     (string, required) The node (see getpeerinfo for nodes)\n"
            "\nExamples:\n"
            + HelpExampleCli("disconnectnode", "\"192.168.0.6:41888\"")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:41888\"")
        );
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:41888\",  (string) The MIL server IP and port we're connected to\n"
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "network",            "net_peerCount",          &netpeercount,           true  },
};
