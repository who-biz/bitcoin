 ...
 ******************************************************************************/
 ...
 // 4: 4rd season ending isnt known, so use very far times in future.
 // to add 5th season, change NUM_KMD_SEASONS to 5, add height of activation for fourth season ending one spot before 999999999.
