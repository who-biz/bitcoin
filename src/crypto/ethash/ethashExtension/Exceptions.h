...
struct BadRoot: virtual Exception { public: BadRoot(uint256 const& _root): Exception("BadRoot " + _root.GetHex()), root(_root) {} uint256 root; };
...
struct DAGCreationFailure: virtual Exception { public: DAGCreationFailure(std::string const& _f): Exception("Function " + _f + "() failed.") {} };
...
using errinfo_hash256 = boost::error_info<struct tag_hash, uint256>;
using errinfo_required_h256 = boost::error_info<struct tag_required_h256, uint256>;
using errinfo_got_h256 = boost::error_info<struct tag_get_h256, uint256>;
